...
$toggle-animation-duration: 2 * $transition-duration;
$toggle-size: 40px;

$toggle-color: getColor(text, contrast);
$toggle-color-hover: getColor(text, contrast);
$toggle-color-active: getColor(text, primary);
$toggle-color-scrolled: getColor(text, primary);
